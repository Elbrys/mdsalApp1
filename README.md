...
This repository contains:
	1. A set of folders that is the skeleton for an OpenDaylight MD-SAL application that supports a remote procedure call (RPC).
...
First, just look through the skeleton folders/files of ExampleApp.  There are several key folders and files you need to understand.
	1. Yang
		1. API
			...
			1. This yang file defines the API for your MD-SAL application.  This includes remote procedure calls as well as data elements (this example only has RPCs)
		1. Dependencies
...
Go ahead and do a build on the project.  This will cause auto-generation of many files for you.
	...
	1. Observe that the following java files are auto-generated for you based on the information in the above files.
